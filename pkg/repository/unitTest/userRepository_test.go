...
// 			},
// 			expectedUser: domain.User{Phone: "1"},
// 			expectedErr:  errors.New("there no user"),
// 		},
// 		{
// 			name:        "DB error",
// 			phoneNumber: "1",
...
// 			acthualUser, actualerr := userRepo.FindUserWithNumber(ctx, tt.phoneNumber)

// 			assert.Equal(t, tt.expectedErr, actualerr)
// 			if err == nil {
// 				assert.Equal(t, tt.expectedUser.Phone, acthualUser.Phone)
// 			}
// 			err = mock.ExpectationsWereMet()
// 			assert.NoError(t, err)
// 		})
